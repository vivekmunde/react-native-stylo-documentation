        ...
        <article>
          ...
          <section className="no-vertical-margin-collapse">
            ...
            <Paragraph>
              ...
              Similarly, a list item can be a non-touchable <InlineCode>View</InlineCode> or <InlineCode>TouchableOpacity</InlineCode>, so on &amp; so forth.
            ...
            <Paragraph>
              Stylo provides a <Link href="/stylo-theme">default theme</Link> with all the pre-defined style types &amp; styles with which you can create all kind of components like Avatar, Badge, Form, List etc.
...
`}
              ...
              imageUrl={{ light: "showcase-core-concept-stylish-react-native-components-light.png", dark: "showcase-core-concept-stylish-react-native-components-dark.png" }}
            />
          </section>
